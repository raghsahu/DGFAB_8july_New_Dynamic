...
public class CommingConnAdapter  extends RecyclerView.Adapter<CommingConnAdapter.MyViewHolder> {
    ...
    public CommingConnAdapter(Context context, List<CommingRequestData> doc) {
        mContext=context;
        this.Doc = doc;
