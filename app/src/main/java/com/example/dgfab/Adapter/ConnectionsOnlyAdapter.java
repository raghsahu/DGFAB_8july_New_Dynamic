...
public class ConnectionsOnlyAdapter extends RecyclerView.Adapter<ConnectionsOnlyAdapter.MyViewHolder> {
    ...
    String document;
    int chky,chkn;
    public List<CommingRequestData> Doc;
    private ProgressDialog progressBar;

    public ConnectionsOnlyAdapter(Context context, List<CommingRequestData> doc) {
        mContext=context;
        this.Doc = doc;
