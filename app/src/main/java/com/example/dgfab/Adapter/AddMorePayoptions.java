...
public class AddMorePayoptions   extends RecyclerView.Adapter<AddMorePayoptions.MyViewHolder> {
    ...
    public AddMorePayoptions(Context context, List<AddNews> doc) {
        mContext=context;
        this.Doc = doc;
    ...
    @Override
    public AddMorePayoptions.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.newkeywords, parent, false);
        return new AddMorePayoptions.MyViewHolder(view);
    }



    @Override
    public void onBindViewHolder(final AddMorePayoptions.MyViewHolder holder, final int position) {
